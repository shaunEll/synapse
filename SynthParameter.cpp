...
//Base
SynthParameter::SynthParameter(String newName, byte newId, String parentObj, float chgFac, float minV, float maxV, UpdatableParameterObject * callback_ptr, bool isMod) {
    paramName = newName;
    id = newId;
...
//Int constructor
SynthParameter::SynthParameter(String newName, byte newId, String parentObj, int * param, float chgFac, float minV, float maxV, UpdatableParameterObject * callback_ptr, bool isMod) :
...
//Float constructor
SynthParameter::SynthParameter(String newName, byte newId, String parentObj, float * param, float chgFac, float minV, float maxV, UpdatableParameterObject * callback_ptr, bool isMod) :
    SynthParameter(newName, newId, parentObj, chgFac, minV, maxV, callback_ptr, isMod) {
...
//Byte constructor
SynthParameter::SynthParameter(String newName, byte newId, String parentObj, byte * param, float chgFac, float minV, float maxV, UpdatableParameterObject * callback_ptr, bool isMod) :
    SynthParameter(newName, newId, parentObj, chgFac, minV, maxV, callback_ptr, isMod) {
...
//Bool constructor
SynthParameter::SynthParameter(String newName, byte newId, String parentObj, bool * param, UpdatableParameterObject * callback_ptr, bool isMod) :
    SynthParameter(newName, newId, parentObj, 1, 0, 1, callback_ptr, isMod) {
...
//Enum constructor
SynthParameter::SynthParameter(String newName, byte newId, String parentObj, SYNTH_P * param, byte eStart, byte eLength, UpdatableParameterObject * callback_ptr, bool isMod) :
    SynthParameter(newName, newId, parentObj, 1, 0, 1, callback_ptr, isMod) {
...
//UI Functions
void SynthParameter::increaseParameter(bool shift, bool affectCurrent) {
    switch(paramType) {
    ...
    if(callbackFunction != nullptr && affectCurrent) {
        callbackFunction->processParameterUpdate(id);
    }
}

void SynthParameter::decreaseParameter(bool shift, bool affectCurrent) {
    switch(paramType) {
        case SYNTH_P_TYPE::P_BYTE: {
            byte bValue = (affectCurrent ? * parameterByte : configuredValueByte) - changeFactor * (shift ? shiftFactor : 1);
...
String SynthParameter::getValueString(bool showCurrentValue) {
...
//   P_FLOAT,
//   P_NONE
int SynthParameter::getValueInt(bool showCurrentValue) {
    switch(paramType) {
        case SYNTH_P_TYPE::P_BYTE:
...
byte SynthParameter::getValueByte(bool showCurrentValue) {
    switch(paramType) {      
        case SYNTH_P_TYPE::P_BYTE:
...
void SynthParameter::applyModifier(SynthMatrixConnection * modifier, bool setCurrentValue) {
    switch(paramType) {
        case SYNTH_P_TYPE::P_INT: {
    ...
    if(callbackFunction != nullptr && setCurrentValue) {
        callbackFunction->processParameterUpdate(id);
    }
}
...
//Private methods
void SynthParameter::setValueInt(int nValue, bool setCurrentValue) {
...
void SynthParameter::setValueByte(byte nValue, bool setCurrentValue) {
    if(nValue >= min_value && nValue <= max_value) {
        if(!setCurrentValue) {
...
void SynthParameter::setValueFloat(float nValue, bool setCurrentValue) {
    if(nValue >= min_value && nValue <= max_value) {
        if(!setCurrentValue) {
...
void SynthParameter::setValueBool(bool nValue, bool setCurrentValue) {
    if(!setCurrentValue) {
...
void SynthParameter::setValueEnum(int nValue, bool setCurrentValue) {
